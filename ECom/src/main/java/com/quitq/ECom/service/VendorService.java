...
public class VendorService {
	...
	public void validate(Vendor v) throws InputValidateionException
	{
		if(v==null)
		{
			throw new InputValidateionException("Vendor cannot be null");
		}
		if(v.getBuisnessName()==null||v.getBuisnessName().equals(""))
		{
			throw new InputValidateionException("Buisnessname cannot have null value or empty value");
